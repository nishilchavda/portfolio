...
const Footer = () => {
  ...
  const linkedIn = "https://www.linkedin.com/in/nishil-chavda";
  const github = "https://github.com/nishilchavda";

  return (
    <footer className="xl:px-46 lg:px-36 px-5 relative mt-2 border-t border-slate-900 bg-transparent backdrop-blur-2xl">
      {/* Subtle top glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-0.75 bg-linear-to-r from-transparent via-blue-500/50 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="mt-10 pt-10 border-t border-slate-900 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          <p>
            © {new Date().getFullYear()} Nishil Chavda. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
